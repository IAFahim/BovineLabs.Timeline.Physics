...
namespace BovineLabs.Timeline.Physics
{
    ...
    {
        public PhysicsVelocityData Lerp(in PhysicsVelocityData a, in PhysicsVelocityData b, in float s) => new()
        {
        ...
        public PhysicsVelocityData Add(in PhysicsVelocityData a, in PhysicsVelocityData b) => new()
        {
