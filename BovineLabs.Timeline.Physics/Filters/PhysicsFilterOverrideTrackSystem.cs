...
namespace BovineLabs.Timeline.Physics
{
    ...
    public partial struct PhysicsFilterOverrideTrackSystem : ISystem
    {
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            _activeLookup = state.GetComponentLookup<ActiveFilterOverride>(true);
            _stateLookup = state.GetComponentLookup<PhysicsFilterOverrideState>(true);
            ...
            _disableStaleQuery = SystemAPI.QueryBuilder()
                .WithAll<TrackBinding, TimelineActivePrevious, PhysicsFilterOverrideAnimated>()
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            state.Dependency = new ResetStateTrackJob<PhysicsFilterOverrideState>
            {
            ...
            state.Dependency = new DisableStaleTrackJob<ActiveFilterOverride>
            {
                TrackBindingTypeHandle = bindingType,
